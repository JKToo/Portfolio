...
import Description from "../Sources/Featured_Project_Renewed.png"
      ...
      <Grid container justifyContent="center" spacing={2} style={{ width: "100%", paddingBottom:"50px" }}>
        <Grid item xs>
          ...
          <div data-aos="zoom-out" d ata-aos-duration="3000">
            <img src={Description} style={{height: "400px"}} />
          </div>
        </Grid>
        <Grid item xs >
        ...
        <Grid item xs={12}>
            ...
            <div class="video_model" data-aos="zoom-out" data-aos-duration="3000" style={{ marginTop: "80%" }}>
            ...
            <Grid key={1} item className = "cards">
              <div class="video_model_ipad"  data-aos="zoom-out" data-aos-duration="3000" style={{ marginTop: "40%" }}>
