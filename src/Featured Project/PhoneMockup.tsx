...
const PhoneMockup = forwardRef<HTMLDivElement, PhoneMockupProps>(
  ({ videoSrc, posterSrc }, ref) => (
    <div ref={ref} className="relative mx-auto" style={{ width: 280 }}>
      <div className="relative rounded-[2.5rem] border-[6px] border-muted bg-background overflow-hidden shadow-2xl animate-pulse-glow">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-28 h-6 bg-muted rounded-b-2xl z-10" />
