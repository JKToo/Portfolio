...
export const History = [ 
    ...
    },
    {
      ...
      description6: "- Troubleshoot PCs, iMacs, mobile phones and conference rooms via phone, face-to-face, remotely using NinjaOne, and TeamViewer",
      description7: "- Developed a receptionist web application to significantly improve the company’s check in process",
